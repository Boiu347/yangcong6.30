...
const ONION_STRENGTH_ROWS = [
  {
    ...
    quotes: [
      { user: '吴语遥', context: '放学写完作业后，他会用洋葱补学校没听懂的数学、物理课。', text: '用洋葱上课……学校没听懂。' },
      { user: '徐同学', context: '把洋葱和豆包的“详细”做对比时，他认为洋葱不是更啰嗦，而是更精准。', text: '洋葱的详细会更精准。' },
      { user: '徐同学', context: '解释为什么洋葱更能看懂时，他强调解析完整、全面。', text: '更全面、更详细。更能让大家看得懂的一点。' },
      { user: '徐同学', context: '点“我还是不懂”之后，他感受到洋葱会换成学生能理解的角度继续讲。', text: '洋葱会用一些从你理解得到的角度跟你讲。' },
      { user: '徐同学', context: '继续追问“什么叫理解得到的角度”时，他举出生活化类比。', text: '他会从通俗易懂的……通过这种举例子的方式。' },
      { user: '徐同学', context: '描述拍题精学里再次讲解的语言风格时，他把洋葱和“文绉绉”的讲法区分开。', text: '它会翻译成你能听得懂的那种通俗语言，不会是那种文绉绉的感觉。' },
      { user: '吕同学', context: '他还没用洋葱拍搜，但会在作业帮步骤看不懂时回到洋葱看知识点。', text: '知识点讲解……我要知道他每步能用到哪个知识点。' },
      { user: '吕同学', context: '当知识点没记牢时，他会把作业帮步骤和洋葱知识点组合使用。', text: '如果这里面知识点没记牢的话，就去洋葱看一眼这个知识点，然后再回来再推一遍。' },
      { user: '小林', context: '被问“洋葱的课好在哪”时，他没有讲功能点，而是直接讲可理解性。', text: '我能听。' },
      { user: '小林', context: '他尝试找过小红书等免费网课，但因为听不懂没有持续用。', text: '听不懂，没有办法在那么多的网课里面找到适合我的那几。' },
    ],
  },
  {
    ...
    quotes: [
      { user: '诺诗', context: '她现在的主工具是洋葱，只有洋葱搜不到同题时才切到作业帮。', text: '在洋葱搜不到一样的题，就会用作业帮去搜。' },
      { user: '徐同学', context: '他承认豆包更快，但写完作业、时间比较充足时会切回洋葱。', text: '时间比较充足，会洋葱。' },
      { user: '徐同学', context: '拍题后，他不是先找答案，而是先看洋葱给出的解题思路。', text: '拍完题之后会洋葱的话，它会先给一个思路，先看思路。' },
      { user: '徐同学', context: '评估洋葱准确率时，他说用得不如豆包多，但目前看下来是对的。', text: '洋葱没有豆包用得那么多，所以目前使用过来都是对。' },
      { user: '丁同学', context: '难题会先查洋葱，因为需要更好的解法和相关课程；但中等题赶作业时会被作业帮截流。', text: '碰到很难的题……先用洋葱，更好的解法和相关的课程。' },
      { user: '丁同学', context: '他解释中等题会选更快的作业帮，但脑子转不过弯时会看视频讲解。', text: '脑子转不过来弯的时候，就会看视频讲解。' },
      { user: '丁同学', context: '从题型看，他用洋葱更多是在难题，而不是所有拍搜场景。', text: '洋葱拍的题难题更多。' },
      { user: '小林', context: '被问豆包和洋葱各自优先场景时，他把洋葱放在“完全搞不懂”的场景。', text: '完完全全搞不懂的话，那可以用洋葱。' },
      { user: '小林', context: '被问豆包和洋葱只能留一个时，他先选洋葱，下一句解释原因是“它可以给我上课”。', text: '那肯定是洋葱啊。它可以给我上课。' },
      { user: '小林', context: '谈到如果洋葱做作业批改，他仍会保留快对，但洋葱承担的是解题和视频学习。', text: '解题、做视频才会找洋葱。' },
    ],
  },
  {
    ...
    quotes: [
      { user: '诺诗', context: '她解释为什么从作业帮转向洋葱时，先说的是兴趣，而不是准确率。', text: '让我更有兴趣一点。' },
      { user: '诺诗', context: '追问“洋葱为什么有聊”时，她直接把作业帮定义为太无聊。', text: '作业帮他讲得太无聊了。' },
      { user: '诺诗', context: '提到小洋葱、肖晨、狗蛋等人物后，她认为这些人物让讲题更有趣。', text: '比较有趣。' },
      { user: '诺诗', context: '描述洋葱拍题的说话语气时，她给出的关键词是温柔、委婉、有耐心。', text: '比较温柔的，委婉……有耐心。' },
      { user: '诺诗', context: '把洋葱拍题比作一个人时，她认为它不像老师那么严肃，更像朋友。', text: '朋友……他说话不像老师那么严肃。' },
      { user: '诺诗', context: '对比作业帮时，她说作业帮没有感情，只是在讲题。', text: '没有感情……只是单纯地跟你讲题。' },
    ],
  },
  {
    ...
    quotes: [
      { user: '吴语遥', context: '期末复习时，他会在洋葱找试卷/题，打印后再用学习机批改和精准学补不会的知识点。', text: '在洋葱里面会找一些试卷，然后让我父母打印下来就写了。' },
      { user: '吴语遥', context: '判断自己是否懂了，不是只看答案，而是用精准学再做类似题。', text: '在精准学，然后找类似的题，再做一遍。' },
      { user: '吴语遥', context: '给小猿学习机打 9 分时，他喜欢的标准也是“讲解看得懂”和“类似题有难度”。', text: '一大部分题目讲解的都是可以让我看得懂的……类似的题也不是非常简单。' },
      { user: '徐同学', context: '描述完美体验时，他不是说拿到答案，而是说下次遇到同类题不再错。', text: '同类题之后都会做了……下次弄到这类题，至少大概率不会错了。' },
      { user: '徐同学', context: '他把洋葱定位为更精细化的操作，不适合纯赶时间。', text: '洋葱适合更精细化的操作。' },
      { user: '徐同学', context: '总结洋葱适合谁时，他强调时间充足、有耐心、想把题弄懂的学生。', text: '时间充足的时候，就是比较适合有耐心的一些学生。' },
      { user: '徐同学', context: '说服妈妈付费时，他会从同步、重难点、复习预习、试卷库等多个板块说洋葱价值。', text: '它板块比较多……同步的、重难点的、复习预习试卷库这种。' },
      { user: '徐同学', context: '谈到妈妈是否反对拍题软件时，他认为关键是能不能把同类型题弄明白。', text: '只要把题弄懂就不会反对，主要是同类型的题得弄明白。' },
      { user: '诺诗', context: '她会先看解析，再从答案一步步推导，实在看不懂才继续看别的内容。', text: '我可以从答案一步一步推导出来。' },
      { user: '诺诗', context: '问解题思路/解析的价值时，她直接提到理解、学会解题和举一反三。', text: '让我可以更好地理解那个题目，然后学会解题，举一反三。' },
      { user: '诺诗', context: '作业写完后先圈错题，再用洋葱；她期待的是弄懂题，而不是简单核答案。', text: '解题思路或者解析的时候恍然大悟，原来这个题是这么做的。' },
      { user: '诺诗', context: '追问“什么让你恍然大悟”时，她说关键是洋葱点明考查知识点。', text: '它考的是哪个知识点。' },
      { user: '诺诗', context: '她不会直接抄洋葱步骤，而是自己写一遍，再用红笔补重点和步骤。', text: '我会先自己写一遍，然后再用红笔在旁边把重点和步骤再写下来。' },
      { user: '吕同学', context: '他认为如果看一遍解题思路再写答案，会让知识点理解更深。', text: '可能我对这个知识点的理解会更深。' },
      { user: '吕同学', context: '他在看不懂时来洋葱看知识点讲解，约一半情况会这么做。', text: '10 次得有 5 次吧，有一半。' },
      { user: '吕同学', context: '看完洋葱知识点后，他判断自己会了的方式是能用自己的思路推出来。', text: '我这个自己思路推，能把这题推出来。' },
      { user: '小林', context: '遇到洋葱课上过、但忘记做法的类似题时，他会翻自己记的洋葱笔记。', text: '在洋葱课上面上过有一点类似的，有一点点印象，但是忘记了该怎么做的题。' },
      { user: '小林', context: '他会把作业做完后回去找洋葱视频并记笔记，这种流程“每次都这样”。', text: '每次都这样……我再回去把这个视频给找到，然后我再记。' },
      { user: '小林', context: '被问免费课是否有帮助时，他直接说有帮助，并把实质帮助归因为提分。', text: '有啊……提分。' },
      { user: '小林', context: '继续追问数学成绩提升时，他给出了具体结果。', text: '30 多分。' },
      { user: '小杰', context: '他不是洋葱拍搜用户，但 wiki 记录把他的好体验标准写得很清楚，可作为对照参照。', text: '解析完整，能明白，拍出来的题准确，有举一反三。' },
      { user: '小杰', context: '小杰使用科大讯飞/小猿时，对“好用”的排序是解析先于举一反三。', text: '重要因素排序：1.解析——讲到用户能懂 2.举一反三的做题。' },
      { user: '小杰', context: '他的成功标准是视频讲解能明白，并通过变式题巩固。', text: '视频讲解能明白，举一反三题目难度有质量。' },
    ],
  },
  {
    ...
    quotes: [
      { user: '徐同学', context: '他认为妈妈会比较信任洋葱，因为妈妈听过课，知道洋葱能帮他弄懂题。', text: '就是洋葱这种，它还是比较信任。' },
      { user: '徐同学', context: '对于拍题好在哪里，他把价值落到“弄懂题”和“下次大概率不会错”。', text: '对，只要把这类题目弄懂，下次弄到这类题，至少大概率不会错了。' },
      { user: '小林', context: '给三个工具打分时，他给洋葱 10 分；即使没有对话框也能到 8 分，有对话框到 10 分。', text: '洋葱，我也给它打 10 分吧。' },
      { user: '小林', context: '被问拍题功能建议时，他没有提出很多负面意见，而是认可当前状态。', text: '没有什么太多的，我觉得现在这个样子就不错了。' },
      { user: '小林', context: '被问只能留一个工具时，他选择洋葱，原因是洋葱能承担课程功能。', text: '那肯定是洋葱啊。它可以给我上课。' },
      { user: '小林', context: '他把洋葱和快对分工得很清楚：快对用于核答案，洋葱用于解题和视频学习。', text: '解题、做视频才会找洋葱。' },
      { user: '吴语遥', context: '老师不会讲所有错题，他的 12 道错题课堂上一道都没讲，工具补位了老师无法覆盖的部分。', text: '老师有些题目不会讲……其实一道都没有。' },
      { user: '吴语遥', context: 'wiki 正文总结他的课后固定安排：写完作业后到洋葱上课补学校没听懂内容。', text: '之后用洋葱上课（听在学校没听懂的）到九点。' },
    ],
  },
];
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-[12px] leading-6 text-gray-500">
            这些不是抽象卖点，而是从 JTBD 文档、妙记逐字稿和正文整理里摘出的正向证据。每条都保留触发场景或对比对象，避免只看到一句原声却不知道它从哪里来。
          </p>
        </div>
              ...
              {item.quotes.map((quote) => (
                <blockquote key={`${quote.user}-${quote.text}`} className="rounded-xl border border-gray-100 bg-[#FAFAF8] p-3">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="rounded-full bg-white px-2 py-0.5 text-[10px] font-bold text-gray-400">上下文</span>
                  </div>
                  <p className="mt-2 text-[11px] leading-5 text-gray-500">{quote.context}</p>
                  <p className="mt-2 border-t border-gray-100 pt-2 text-[12px] font-semibold leading-5 text-gray-800">“{quote.text}”</p>
                </blockquote>
              ))}
            </div>
          </article>
