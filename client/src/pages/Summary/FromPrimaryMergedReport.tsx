...
const redesignedCards: InsightCard[] = [
  {
    ...
    data: '一手材料来源：访谈纪要/文字记录（用户1、用户2、用户3、用户6、用户8）。用户1强调低年级“有个概念”、不是提前学；用户2明确区分“学科启蒙/兴趣启蒙”；用户6因科学课主科化产生同步诉求；用户8因孩子喜欢和未来初高中不吃力购买。',
    takeaways: [
      { label: '判断', text: '核心目标用户不是所有启蒙家庭，而是小学1-4年级里已经开始考虑未来理科学习、但又不想过早应试的家庭；另有科学主科化地区的同步型强需求。' },
      { label: '依据', text: '一手访谈：用户1说低年级只需“有个概念”，不是提前学完初中；用户2说科学更偏“学科启蒙”，为了以后中高考/初高中理科；用户3说“兴趣是起点，学科思维是最终目的”；用户6因郑州科学课期中期末都考，希望孩子理解而非死记硬背。' },
