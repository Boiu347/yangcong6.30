...
const redesignedCards: InsightCard[] = [
  {
    ...
    takeaways: [
      { label: '判断', text: '八位家长可归为四类画像，但核心盘高度重叠：都要低压力地建立理科概念，不要超前刷题，也不想只看热闹。1–4 年级与这套诉求最匹配；科学主科化地区另有同步型高需。本条洞察在于：细分是为了分话术，不是为了拆产品线——共性远大于差异。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '「兴趣」是家长开口的第一理由，但继续追问后几乎都会回到：将来学理科别排斥、别畏难、有基本概念。竞品已在卖学科焦虑，却没人把「学科启蒙」这门课讲清楚——这是购买合理性的空白，也是洋葱卖点的切入点。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '家长心里有两本账：今天看孩子愿不愿点开，将来初中能不能少吃力。前者现在就能判断，后者要等三四年，中间缺少可感知的阶段标准——所以短期反馈和长期价值必须写进同一套产品叙事，不能只讲远景。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '「孩子爱看」只证明入口成立，不能证明启蒙成功。家长缺的是小学阶段的「有效信号」：能否解释现象、讲出原理、让家长听见变化。谁能把这段路径讲清并做出来，谁就能降低下单与续费的不确定性——这也是全赛道尚未填满的差异化位。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '家长很少在第一次看到内容时就完成购买。新媒体适合建立「学科启蒙」的第一印象，APP 适合补全大纲、试听和 FAQ，电销适合已有信任的高客单补刀——三条链路缺一环，种草用户就会在中途流失。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '家长理想中的启蒙课，不是「短、好玩」就结束了，而是五件事同时成立：有体系、讲得专业、资源够丰富、能挂钩未来初中、整体好理解。动画趣味只是入场券，不能替代表达这五个诉求标准。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '下单前家长有两条心理红线：不要变成超前应试课，也不能只是看着玩。他们要的是「现在学得轻松，将来接得上」——售卖话术必须同时过「不抢跑」和「有收获」两道关，单押任何一边都会吓退或劝退。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '多数成交靠品牌信任、大会员顺手加购或顺带推荐，而不是被「小学物理课卖点」本身击中。品牌可以兜底存量转化，但规模放大时课程必须能独立回答「为什么买这一门」——否则增量永远绑在大会员上。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '买后好评高度集中在同一组合：短视频节奏不施压、目录系统能自选、实验男让孩子主动刷。正向体验不是单一「有趣」，而是低门槛进入后仍感觉「有东西可学」——这是对外证言最该保留的三条体验锚点。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '负向体验不是「没内容」，而是「孩子够不着、家长找不到、用不下去」：概念词太书面、答题要认字、与校内科学对不上、新鲜感过去就不看了。折损发生在使用环节，瓶颈在儿童化表达和持续机制，不在素材数量。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '很多认可课程的家长，卡在使用意愿和可用时间：主科与兴趣班挤压、孩子不会自己打开、囤课后没有节奏。问题常在家庭侧的执行摩擦，而非否认课程价值——轻量任务和零压力定位，比再加内容更能缓解这类卡点。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '要卖出「学科启蒙」，产品必须先过两道关：专业概念能否讲成孩子的话，启蒙成果能否让家长看见。定位模糊、实验感弱、同步检索差会叠加放大流失，但儿童化和效果外化是当前最能直接抬转化与续费的两项。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '未购用户常在「有点兴趣」和「愿意付钱」之间断档：种草若只给立即下单，愿意了解的人没有承接；想深入的人缺试听与 FAQ；老用户又缺权益升级触点。商业化卡点本质是漏斗断裂，不是某个单渠道不够强。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '洋葱已具备「孩子愿意看」和「比竞品更系统」两项硬底子，但心智仍停在品牌层，尚未形成「小学物理非买不可」的独立理由。下一步不是否定现有优势，而是把动画与体系翻译成家长一听就懂的课程记忆点。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '家长对 NB、妙懂、万物指南、直播课都能一句话说清「为什么买」：安全实验、AR 直观、权威 IP、真人带做。竞品赢在单点钩子清晰可复述；洋葱若仍用分散功能点应战，比较优势会在家长心智里被稀释。' },
  ...
  },
  {
    ...
    takeaways: [
      { label: '判断', text: '洋葱不必通吃所有启蒙家庭，最强位置在中段衔接型：既怕过早功利，又怕纯科普白看。比纯兴趣课更系统、比正式抢跑课更轻——这个「中间位」才是对比叙事应反复锚定的差异，而不是全面罗列功能清单。' },
