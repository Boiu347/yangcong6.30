...
const redesignedCards: InsightCard[] = [
  {
    ...
    data: '来源说明：访谈纪要/文字记录，涉及用户1、用户2、用户3、用户6、用户8。',
    takeaways: [
      { label: '判断', text: '核心目标用户不是所有启蒙家庭，而是小学1-4年级里已经开始考虑未来理科学习、但又不想过早应试的家庭；另有科学主科化地区的同步型强需求。' },
      { label: '依据', text: '从一手访谈看，低年级家长普遍不是在追求提前学完整体系，而是在寻找“先建立概念、降低后续学习门槛”的启蒙内容。部分家长明确提到低年级阶段只需要“有个概念”，也有家长把小学物理视为后续初高中理科学习的铺垫；在科学课主科化地区，家长还会把它和校内科学理解、避免死记硬背联系起来。' },
