import { Brain, ChevronRight, Quote, Target } from 'lucide-react';
...
const LEARNING_INSIGHTS: GradeLearningInsight[] = [
  {
    ...
    pains: [
      ...
      },
      {
        ...
        quotes: [{ text: '一年级没必要拔苗助长这么快，你要让他感兴趣，先把兴趣提上来。', source: '启蒙观 · 998 · 北京大兴' }],
  ...
  },
  {
    ...
    pains: [
      ...
      },
      {
        ...
        quotes: [{ text: '弟弟一年级，主要是课内复习预习、练计算，给他出一些计算练习册，没搞太多。', source: '1年级 · 家庭包 · 江西九江' }],
    ...
    pains: [
      {
        ...
        quotes: [{ text: '每天写完作业就到十点了，中途还要看小猪佩奇休息，要三个小时。', source: '2年级 · 998 · 浙江杭州' }],
  ...
  },
  {
    ...
    pains: [
      ...
      },
      {
        ...
        detail: '如果不知道洋葱在某科具体解决什么问题，家长就容易搁置。',
        quotes: [
  ...
  },
  {
    ...
    pains: [
      ...
      },
      {
        ...
        quotes: [{ text: '同一类型题可以做三道，刷够基础再推举一反三，有的练习册这个板块做得挺好，可以借鉴。', source: '4年级 · 998 · 河北唐山' }],
    ...
    pains: [
      {
        ...
        quotes: [{ text: '数学压轴题攻不下，又请不起一对一。', source: '初中 · 998 首购调研' }],
    ...
    pains: [
      {
        ...
        quotes: [{ text: '我知道我不懂的知识点，洋葱能很好帮我弄明白，但是我没有时间看完。', source: '备考画像 · 高压学习场景' }],
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-[#f8f8f5]">
      <div className="mx-auto max-w-[1440px] px-5 py-5">
        <section className="border border-[#dddcd5] bg-white">
          <div className="grid gap-px bg-[#e5e4de] xl:grid-cols-[minmax(0,1.35fr)_420px]">
            <div className="bg-white p-6 md:p-7">
              ...
              <h1 className="mt-3 max-w-4xl text-2xl font-extrabold leading-tight text-[#252525] md:text-3xl">
                逐年级学习痛点洞察：从<span className="mx-1 rounded bg-[#fff0ea] px-1.5 text-[#e65532]">兴趣和陪伴</span>
              ...
              <p className="mt-3 max-w-4xl text-sm leading-7 text-[#666]">
                将 998 与家庭包访谈中和孩子学习状态相关的原声，按具体年级归位，观察每个节点真正卡住孩子和家长的学习痛点。
              </p>
            ...
            <div className="grid grid-cols-2 gap-px bg-[#e5e4de]">
              ...
              <LearningMetric label="代表原声" value={quoteCount} note="只保留学习痛点相关" />
              <LearningMetric label="演进规律" value={CROSS_LEARNING_INSIGHTS.length} note="跨年级归纳" />
            </div>
          </div>
        </section>

        <section className="mt-5 border border-[#dddcd5] bg-white p-4">
        ...
        <section className="mt-5 border border-[#dddcd5] bg-white">
          <div className="border-b border-[#e5e4de] px-5 py-4">
            ...
            <p className="mt-1 text-sm leading-6 text-[#666]">这里只保留学习痛点规律，不纳入售卖转化、价格判断或账号权益类结论。</p>
          </div>
        ...
        <div className="mt-5 border border-[#dddcd5] bg-white px-5 py-3 text-xs leading-5 text-[#777]">
          数据来源：本地《逐年级学习痛点洞察》整理稿，引用 998 小学/初中首购与家庭包访谈中和学习状态、课程使用、理解困难直接相关的原声。
        </div>
      </div>
    </main>
  );
